...
from utils.utils_model import weights_init
...
class mit_b0(MixVisionTransformer):
    def __init__(self, pretrained=False, backbone_weight_path=''):
        ...
        if pretrained:
            ...
            self.load_state_dict(torch.load(backbone_weight_path, weights_only=True), strict=False)
